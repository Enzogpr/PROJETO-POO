...
public class PgSupabase implements IUserRepository {
    ...
    public UserAccountDTO createUser(UserAccountDTO dto) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(insertQuery)) {
            ...
            preparedStatement.setString(6, dto.getAccountNumber());
            preparedStatement.setObject(7, dto.getCreateAt());
    ...
    public UserAccountDTO findUserBy(String document) {
        ...
        String query = "SELECT id, document, name, email, password, account_number, created_at, disabled_at FROM users WHERE document = '" + document + "';";
